 ...
 *  - 1   - C sources, object files, Java sources and class files,
...
instance:
     ...
     * Alias for --filter=5
     *
     * This flag was used for requesting aggressive filtering. It was superceded
     * by 'filter'.
     */
    @CommandOption('f')
     ...
     * 0   - all files are preserved
     * 1   - C sources, object files, Java sources and class files, PDF files and
     *       internal RTSC files are deleted
     * 2   - left for future expansion, currently same as 1
